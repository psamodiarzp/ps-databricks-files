...
and merchant_id='Ba2esp2346gBmV'
...
select payments.order_id, 
  ...
  */
  and payments.merchant_id = 'Ba2esp2346gBmV'
...
att_name_label = ['Rage_Coffee_daily_report_']
subject_label = ['Daily Report from Razorpay Magic Checkout: Rage Coffee',]
